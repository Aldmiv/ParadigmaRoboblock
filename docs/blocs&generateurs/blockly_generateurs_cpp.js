...
Blockly.Arduino['ardublock_block1'] = function(block) {
    //  в разработке движение вперёд ок назад нет
    var deistvie = block.getFieldValue('deistvie');
    var delay = block.getFieldValue('delay');
...
Blockly.Arduino['esp32ledi_ws2812'] = function(block) {
    var numberstrip = block.getFieldValue('Pin');
    // номер
    var pin_ledrgb = block.getFieldValue('Pin');
    // пин ленты
    var numpixels = block.getFieldValue('ledoff');
    ...
    var valueledon = block.getFieldValue('ledon');
    //start
    var valueledoff = block.getFieldValue('ledoff');
    //stop
...
Blockly.Arduino['bt_key_cliker1'] = function(block) {
    ...
    if (value_dropdown == "up") {
        var code = ' for (int count = 0; count < ' + value_text + '; count++) {  \n  bleMouse.move(0,0,1); \n delay(10); \n }  \n';
    }
    if (value_dropdown == "down") {
        var code = ' for (int count = 0; count < ' + value_text + '; count++) {  \n  bleMouse.move(0,0,-1); \n delay(10); \n }  \n';
    }
    if (value_dropdown == "left") {
        var code = ' for (int count = 0; count < ' + value_text + '; count++) {  \n  bleMouse.move(0,0,0,-1); \n delay(10); \n }  \n';
    }
    if (value_dropdown == "right") {
        var code = ' for (int count = 0; count < ' + value_text + '; count++) {  \n  bleMouse.move(0,0,0,1); \n delay(10); \n }  \n';
    }
...
Blockly.Arduino['lcdi2c_setcursor_draw32'] = function(block) {
    ...
    var Pix0e0 = this.getFieldValue('Pix0e0');
    if (Pix0e0 == 'FALSE') {
        Pix0e0 = 0;
    } else {
        Pix0e0 = 1;
    }
    var Pix0e1 = this.getFieldValue('Pix0e1');
    if (Pix0e1 == 'FALSE') {
        Pix0e1 = 0;
    } else {
        Pix0e1 = 1;
    }
    var Pix0e2 = this.getFieldValue('Pix0e2');
    if (Pix0e2 == 'FALSE') {
        Pix0e2 = 0;
    } else {
        Pix0e2 = 1;
    }
    var Pix0e3 = this.getFieldValue('Pix0e3');
    if (Pix0e3 == 'FALSE') {
        Pix0e3 = 0;
    } else {
        Pix0e3 = 1;
    }
    var Pix0e4 = this.getFieldValue('Pix0e4');
    if (Pix0e4 == 'FALSE') {
        Pix0e4 = 0;
    } else {
        Pix0e4 = 1;
    ...
    var Pix1e0 = this.getFieldValue('Pix1e0');
    if (Pix1e0 == 'FALSE') {
        Pix1e0 = 0;
    } else {
        Pix1e0 = 1;
    }
    var Pix1e1 = this.getFieldValue('Pix1e1');
    if (Pix1e1 == 'FALSE') {
        Pix1e1 = 0;
    } else {
        Pix1e1 = 1;
    }
    var Pix1e2 = this.getFieldValue('Pix1e2');
    if (Pix1e2 == 'FALSE') {
        Pix1e2 = 0;
    } else {
        Pix1e2 = 1;
    }
    var Pix1e3 = this.getFieldValue('Pix1e3');
    if (Pix1e3 == 'FALSE') {
        Pix1e3 = 0;
    } else {
        Pix1e3 = 1;
    }
    var Pix1e4 = this.getFieldValue('Pix1e4');
    if (Pix1e4 == 'FALSE') {
        Pix1e4 = 0;
    } else {
        Pix1e4 = 1;
    ...
    var Pix2e0 = this.getFieldValue('Pix2e0');
    if (Pix2e0 == 'FALSE') {
        Pix2e0 = 0;
    } else {
        Pix2e0 = 1;
    }
    var Pix2e1 = this.getFieldValue('Pix2e1');
    if (Pix2e1 == 'FALSE') {
        Pix2e1 = 0;
    } else {
        Pix2e1 = 1;
    }
    var Pix2e2 = this.getFieldValue('Pix2e2');
    if (Pix2e2 == 'FALSE') {
        Pix2e2 = 0;
    } else {
        Pix2e2 = 1;
    }
    var Pix2e3 = this.getFieldValue('Pix2e3');
    if (Pix2e3 == 'FALSE') {
        Pix2e3 = 0;
    } else {
        Pix2e3 = 1;
    }
    var Pix2e4 = this.getFieldValue('Pix2e4');
    if (Pix2e4 == 'FALSE') {
        Pix2e4 = 0;
    } else {
        Pix2e4 = 1;
    ...
    var Pix3e0 = this.getFieldValue('Pix3e0');
    if (Pix3e0 == 'FALSE') {
        Pix3e0 = 0;
    } else {
        Pix3e0 = 1;
    }
    var Pix3e1 = this.getFieldValue('Pix3e1');
    if (Pix3e1 == 'FALSE') {
        Pix3e1 = 0;
    } else {
        Pix3e1 = 1;
    }
    var Pix3e2 = this.getFieldValue('Pix3e2');
    if (Pix3e2 == 'FALSE') {
        Pix3e2 = 0;
    } else {
        Pix3e2 = 1;
    }
    var Pix3e3 = this.getFieldValue('Pix3e3');
    if (Pix3e3 == 'FALSE') {
        Pix3e3 = 0;
    } else {
        Pix3e3 = 1;
    }
    var Pix3e4 = this.getFieldValue('Pix3e4');
    if (Pix3e4 == 'FALSE') {
        Pix3e4 = 0;
    } else {
        Pix3e4 = 1;
    ...
    var Pix4e0 = this.getFieldValue('Pix4e0');
    if (Pix4e0 == 'FALSE') {
        Pix4e0 = 0;
    } else {
        Pix4e0 = 1;
    }
    var Pix4e1 = this.getFieldValue('Pix4e1');
    if (Pix4e1 == 'FALSE') {
        Pix4e1 = 0;
    } else {
        Pix4e1 = 1;
    }
    var Pix4e2 = this.getFieldValue('Pix4e2');
    if (Pix4e2 == 'FALSE') {
        Pix4e2 = 0;
    } else {
        Pix4e2 = 1;
    }
    var Pix4e3 = this.getFieldValue('Pix4e3');
    if (Pix4e3 == 'FALSE') {
        Pix4e3 = 0;
    } else {
        Pix4e3 = 1;
    }
    var Pix4e4 = this.getFieldValue('Pix4e4');
    if (Pix4e4 == 'FALSE') {
        Pix4e4 = 0;
    } else {
        Pix4e4 = 1;
    ...
    var Pix5e0 = this.getFieldValue('Pix5e0');
    if (Pix5e0 == 'FALSE') {
        Pix5e0 = 0;
    } else {
        Pix5e0 = 1;
    }
    var Pix5e1 = this.getFieldValue('Pix5e1');
    if (Pix5e1 == 'FALSE') {
        Pix5e1 = 0;
    } else {
        Pix5e1 = 1;
    }
    var Pix5e2 = this.getFieldValue('Pix5e2');
    if (Pix5e2 == 'FALSE') {
        Pix5e2 = 0;
    } else {
        Pix5e2 = 1;
    }
    var Pix5e3 = this.getFieldValue('Pix5e3');
    if (Pix5e3 == 'FALSE') {
        Pix5e3 = 0;
    } else {
        Pix5e3 = 1;
    }
    var Pix5e4 = this.getFieldValue('Pix5e4');
    if (Pix5e4 == 'FALSE') {
        Pix5e4 = 0;
    } else {
        Pix5e4 = 1;
    ...
    var Pix6e0 = this.getFieldValue('Pix6e0');
    if (Pix6e0 == 'FALSE') {
        Pix6e0 = 0;
    } else {
        Pix6e0 = 1;
    }
    var Pix6e1 = this.getFieldValue('Pix6e1');
    if (Pix6e1 == 'FALSE') {
        Pix6e1 = 0;
    } else {
        Pix6e1 = 1;
    }
    var Pix6e2 = this.getFieldValue('Pix6e2');
    if (Pix6e2 == 'FALSE') {
        Pix6e2 = 0;
    } else {
        Pix6e2 = 1;
    }
    var Pix6e3 = this.getFieldValue('Pix6e3');
    if (Pix6e3 == 'FALSE') {
        Pix6e3 = 0;
    } else {
        Pix6e3 = 1;
    }
    var Pix6e4 = this.getFieldValue('Pix6e4');
    if (Pix6e4 == 'FALSE') {
        Pix6e4 = 0;
    } else {
        Pix6e4 = 1;
    ...
    var Pix7e0 = this.getFieldValue('Pix7e0');
    if (Pix7e0 == 'FALSE') {
        Pix7e0 = 0;
    } else {
        Pix7e0 = 1;
    }
    var Pix7e1 = this.getFieldValue('Pix7e1');
    if (Pix7e1 == 'FALSE') {
        Pix7e1 = 0;
    } else {
        Pix7e1 = 1;
    }
    var Pix7e2 = this.getFieldValue('Pix7e2');
    if (Pix7e2 == 'FALSE') {
        Pix7e2 = 0;
    } else {
        Pix7e2 = 1;
    }
    var Pix7e3 = this.getFieldValue('Pix7e3');
    if (Pix7e3 == 'FALSE') {
        Pix7e3 = 0;
    } else {
        Pix7e3 = 1;
    }
    var Pix7e4 = this.getFieldValue('Pix7e4');
    if (Pix7e4 == 'FALSE') {
        Pix7e4 = 0;
    } else {
        Pix7e4 = 1;
