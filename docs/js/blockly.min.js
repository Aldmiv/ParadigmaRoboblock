...
goog.retrieveAndExec_ = function(a, b, c) {
    if (!COMPILED) {
        ...
        goog.IS_OLD_IE_ ? (goog.dependencies_.deferred[d] = f,
        goog.queuedModules_.push(d)) : e(a, f)
    }
}
;
    ...
    for (var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0; 0 == c && g < f; g++) {
        ...
        do {
            ...
            var c = 0 == h[1].length ? 0 : parseInt(h[1], 10)
              ...
              , c = goog.string.compareElements_(c, m) || goog.string.compareElements_(0 == h[2].length, 0 == k[2].length) || goog.string.compareElements_(h[2], k[2])
              , h = h[3]
              , k = k[3]
        } while (0 == c)
    }
...
goog.html.SafeStyle.create = function(a) {
    ...
    for (c in a) {
        ...
        var d = a[c];
        null != d && (d instanceof goog.string.Const ? (d = goog.string.Const.unwrap(d),
        goog.asserts.assert(!/[{;}]/.test(d), "Value does not allow [{;}].")) : goog.html.SafeStyle.VALUE_RE_.test(d) ? goog.html.SafeStyle.hasBalancedQuotes_(d) || (goog.asserts.fail("String value requires balanced quotes, got: " + d),
        d = goog.html.SafeStyle.INNOCUOUS_STRING) : (goog.asserts.fail("String value allows only [-,.\"'%_!# a-zA-Z0-9], rgb() and rgba(), got: " + d),
...
goog.dom.safe.setLinkHrefAndRel = function(a, b, c) {
    ...
    a.href = goog.html.TrustedResourceUrl.unwrap(b)) : a.href = b instanceof goog.html.TrustedResourceUrl ? goog.html.TrustedResourceUrl.unwrap(b) : b instanceof goog.html.SafeUrl ? goog.html.SafeUrl.unwrap(b) : goog.html.SafeUrl.sanitize(b).getTypedStringValue()
}
;
...
goog.dom.vendor.getPrefixedPropertyName = function(a, b) {
    ...
    !goog.isDef(b) || c in b ? c : null) : null
}
;
...
goog.style.setPosition = function(a, b, c) {
    var d;
    b instanceof goog.math.Coordinate ? (d = b.x,
    b = b.y) : (d = b,
    b = c);
...
goog.style.installSafeStyleSheet = function(a, b) {
    ...
    goog.style.setSafeStyleSheet(d, a)) : (e = c.getElementsByTagNameAndClass("HEAD")[0],
    e || (d = c.getElementsByTagNameAndClass("BODY")[0],
    e = c.createDom("HEAD"),
...
goog.async.FreeList.prototype.get = function() {
    var a;
    0 < this.occupants_ ? (this.occupants_--,
    a = this.head_,
    this.head_ = a.next,
    a.next = null) : a = this.create_();
    return a
}
;
...
goog.events.EventTarget.dispatchEventInternal_ = function(a, b, c) {
    ...
    if (c)
        for (var g = c.length - 1; !b.propagationStopped_ && 0 <= g; g--)
            f = b.currentTarget = c[g],
            e = f.fireListeners(d, !0, b) && e;
    b.propagationStopped_ || (f = b.currentTarget = a,
    e = f.fireListeners(d, !0, b) && e,
...
goog.events.EventHandler.prototype.unlisten = function(a, b, c, d, e) {
    ...
    else if (a = goog.events.getListener(a, b, c || this.handleEvent, d, e || this.handler_ || this))
...
goog.events.KeyHandler.prototype.handleEvent = function(a) {
    ...
    goog.userAgent.IE && a.type == goog.events.EventType.KEYPRESS ? (c = this.keyCode_,
    d = c != goog.events.KeyCodes.ENTER && c != goog.events.KeyCodes.ESC ? b.keyCode : 0) : (goog.userAgent.WEBKIT || goog.userAgent.EDGE) && a.type == goog.events.EventType.KEYPRESS ? (c = this.keyCode_,
    d = 0 <= b.charCode && 63232 > b.charCode && goog.events.KeyCodes.isCharacterKey(c) ? b.charCode : 0) : goog.userAgent.OPERA && !goog.userAgent.WEBKIT ? (c = this.keyCode_,
    d = goog.events.KeyCodes.isCharacterKey(c) ? b.keyCode : 0) : (c = b.keyCode || this.keyCode_,
    d = b.charCode || 0,
    goog.events.KeyHandler.SAVE_ALT_FOR_KEYPRESS_ && (e = this.altKey_),
    goog.userAgent.MAC && d == goog.events.KeyCodes.QUESTION_MARK && c == goog.events.KeyCodes.WIN_KEY && (c = goog.events.KeyCodes.SLASH));
    var f = c = goog.events.KeyCodes.normalizeKeyCode(c);
    c ? 63232 <= c && c in goog.events.KeyHandler.safariKey_ ? f = goog.events.KeyHandler.safariKey_[c] : 25 == c && a.shiftKey && (f = 9) : b.keyIdentifier && b.keyIdentifier in goog.events.KeyHandler.keyIdentifier_ && (f = goog.events.KeyHandler.keyIdentifier_[b.keyIdentifier]);
    a = f == this.lastKey_;
    this.lastKey_ = f;
...
goog.ui.Control.prototype.enableMouseEventHandling_ = function(a) {
    var b = this.getHandler()
      , c = this.getElement();
    a ? (b.listen(c, goog.events.EventType.MOUSEOVER, this.handleMouseOver).listen(c, goog.events.EventType.MOUSEDOWN, this.handleMouseDown).listen(c, goog.events.EventType.MOUSEUP, this.handleMouseUp).listen(c, goog.events.EventType.MOUSEOUT, this.handleMouseOut),
    this.handleContextMenu != goog.nullFunction && b.listen(c, goog.events.EventType.CONTEXTMENU, this.handleContextMenu),
    goog.userAgent.IE && (goog.userAgent.isVersionOrHigher(9) || b.listen(c, goog.events.EventType.DBLCLICK, this.handleDblClick),
    ...
    this.registerDisposable(this.ieMouseEventSequenceSimulator_)))) : (b.unlisten(c, goog.events.EventType.MOUSEOVER, this.handleMouseOver).unlisten(c, goog.events.EventType.MOUSEDOWN, this.handleMouseDown).unlisten(c, goog.events.EventType.MOUSEUP, this.handleMouseUp).unlisten(c, goog.events.EventType.MOUSEOUT, this.handleMouseOut),
    this.handleContextMenu != goog.nullFunction && b.unlisten(c, goog.events.EventType.CONTEXTMENU, this.handleContextMenu),
    goog.userAgent.IE && (goog.userAgent.isVersionOrHigher(9) || b.unlisten(c, goog.events.EventType.DBLCLICK, this.handleDblClick),
...
goog.ui.MenuItem.prototype.handleMouseUp = function(a) {
    ...
    if (b) {
        ...
        if (c && goog.isNumber(a.clientX) && (b = new goog.math.Coordinate(a.clientX,a.clientY),
...
goog.structs.Map.prototype.cleanupKeysArray_ = function() {
    ...
    if (this.count_ != this.keys_.length) {
        for (var d = {}, b = a = 0; a < this.keys_.length; )
            c = this.keys_[a],
            goog.structs.Map.hasKey_(d, c) || (this.keys_[b++] = c,
            d[c] = 1),
            a++;
        this.keys_.length = b
    }
...
goog.structs.Map.prototype.addAll = function(a) {
    var b;
    a instanceof goog.structs.Map ? (b = a.getKeys(),
...
goog.debug.enhanceError = function(a, b) {
    var c;
    a instanceof Error ? c = a : (c = Error(a),
...
goog.ui.tree.BaseNode.prototype.initAccessibility = function() {
    ...
    if (a) {
        ...
        if (a = this.getChildrenElement())
            if (goog.a11y.aria.setRole(a, "group"),
            a.hasChildNodes())
                for (a = this.getChildCount(),
                b = 1; b <= a; b++) {
...
goog.ui.tree.BaseNode.prototype.setExpanded = function(a) {
    ...
    if (!b || this.dispatchEvent(a ? goog.ui.tree.BaseNode.EventType.BEFORE_EXPAND : goog.ui.tree.BaseNode.EventType.BEFORE_COLLAPSE)) {
        ...
        d && (this.updateIcon_(),
        goog.a11y.aria.setState(d, "expanded", a));
...
Blockly.Connection.prototype.disconnect = function() {
    ...
    var b, c;
    this.isSuperior() ? (b = this.sourceBlock_,
    c = a.getSourceBlock(),
    a = this) : (b = a.getSourceBlock(),
    c = this.sourceBlock_);
...
goog.events.BrowserFeature.TOUCH_ENABLED && (Blockly.Scrollbar.scrollbarThickness = 15);
...
Blockly.Trashcan.prototype.MARGIN_BOTTOM_ = 5;
Blockly.Trashcan.prototype.MARGIN_SIDE_ = 5;
Blockly.Trashcan.prototype.MARGIN_HOTSPOT_ = 5;
...
Blockly.ZoomControls.prototype.createDom = function() {
    ...
    e.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", l.options.pathToMedia + Blockly.SPRITE.url),
    o = Blockly.createSvgElement("clipPath", {
    ...
    return i.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", l.options.pathToMedia + Blockly.SPRITE.url),
    o = Blockly.createSvgElement("clipPath", {
    ...
    }, this.svgGroup_)).setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", l.options.pathToMedia + Blockly.SPRITE.url),
    Blockly.bindEventWithChecks_(t, "mousedown", null, function(t) {
        l.markFocused(),
        l.setScale(l.options.zoomOptions.startScale),
        l.scrollCenter(),
        Blockly.Touch.clearTouchIdentifier(),
        t.stopPropagation(),
        t.preventDefault()
    }),
    Blockly.bindEventWithChecks_(i, "mousedown", null, function(t) {
        l.markFocused(),
        l.zoomCenter(1),
        Blockly.Touch.clearTouchIdentifier(),
        t.stopPropagation(),
    ...
    Blockly.bindEventWithChecks_(e, "mousedown", null, function(t) {
        l.markFocused(),
        l.zoomCenter(-1),
        Blockly.Touch.clearTouchIdentifier(),
        t.stopPropagation(),
...
Blockly.RenderedConnection.prototype.unhideAll = function() {
    ...
    if (b) {
        ...
        b.previousConnection && c.push(b.previousConnection)) : c = b.getConnections_(!0);
...
Blockly.BlockSvg.prototype.getBoundingRectangle = function() {
    ...
    this.RTL ? (d = new goog.math.Coordinate(a.x - (c.width - b),a.y),
    a = new goog.math.Coordinate(a.x + b,a.y + c.height)) : (d = new goog.math.Coordinate(a.x - b,a.y),
...
Blockly.BlockSvg.prototype.setHighlighted = function(a) {
    a ? (this.svgPath_.setAttribute("filter", "url(#" + this.workspace.options.embossFilterId + ")"),
    this.svgPathLight_.style.display = "none") : (this.svgPath_.removeAttribute("filter"),
...
Blockly.BlockSvg.prototype.renderCompute_ = function(a) {
    ...
    for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, m = this.getInputsInline() && !this.isCollapsed(), p = 0, l; l = b[p]; p++)
        if (l.isVisible()) {
            var n;
            m && k && k != Blockly.NEXT_STATEMENT && l.type != Blockly.NEXT_STATEMENT ? n = c[c.length - 1] : (k = l.type,
            n = [],
...
Blockly.Events.Move.prototype.run = function(a) {
    ...
    if (c) {
        ...
        if (a)
            ...
            var c = c.outputConnection || c.previousConnection, g;
            if (e) {
                if (b = f.getInput(e))
                    g = b.connection
            } else
...
Blockly.FieldVariable.dropdownCreate = function() {
    ...
    a.push(Blockly.Msg.RENAME_VARIABLE.replace("%1", b));
...
Blockly.Generator.prototype.provideFunction_ = function(a, b) {
    if (!this.definitions_[a]) {
        ...
        for (var c = b.join("\n").replace(this.FUNCTION_NAME_PLACEHOLDER_REGEXP_, c), d; d != c; )
            d = c,
...
if (typeof process === 'undefined') {
    ...
    Blockly.prompt = function(a, b, c) {
        c(ipcRenderer.sendSync("modalVar", a))
    }
    ;
}
