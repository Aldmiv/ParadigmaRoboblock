    ...
    (function() {
                ...
                for (var r = 0; r < e.length; r++) {
                    ...
                    if (typeof i == "object") {
                        ...
                        if (i.changeCase && i.local) {
                            var u = e[r + 1];
                            u && typeof u == "string" && (i.changeCase == "u" ? e[r] = u[0].toUpperCase() : e[r] = u[0].toLowerCase(),
                            e[r + 1] = u.substr(1))
                        } else
                ...
                if (typeof i == "string")
                    ...
                    if (i.skip)
                        ...
                        if (i.text) {
                            ...
                            i.processed = r,
                            i.expectIf == null ? s && (n.push(s),
                            o(i)) : s ? i.skip = i.elseBranch : o(i)
                        } else
        ...
        this.insertSnippetForSelection = function(e, t) {
            ...
            o.forEach(function(e) {
                if (typeof e == "string") {
                    var t = e.split("\n");
                    t.length > 1 ? (y = t[t.length - 1].length,
                    g += t.length - 1) : y += e.length,
                    b += e
                } else
                    e.start ? e.end = {
                        row: g,
        ...
        this.getActiveScopes = function(e) {
            var t = this.$getScope(e)
              , n = [t]
              , r = this.snippetMap;
            return r[t] && r[t].includeScopes && n.push.apply(n, r[t].includeScopes),
            n.push("_"),
            n
        }
        ,
        this.expandWithTab = function(e, t) {
            ...
            return r && e.tabstopManager && e.tabstopManager.tabNext(),
            r
        }
        ,
        ...
        this.addTabstops = function(e, t, n) {
            ...
            e.forEach(function(e, n) {
                ...
                for (var i = e.length; i--; ) {
                    ...
                    a.fmtString ? (f.linked = !0,
                    r.hasLinkedRanges = !0) : r.firstNonLinked || (r.firstNonLinked = f)
                }
                r.firstNonLinked || (r.hasLinkedRanges = !1),
                r === e && (s.push(r),
                this.$openTabstops[n] = r),
                this.addTabstopMarkers(r)
            }, this),
            s.length > 2 && (this.tabstops.length && s.push(s.splice(2, 1)[0]),
